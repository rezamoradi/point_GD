...
PYBIND11_MODULE(knn_cuda_pytorch3D, m) {
    m.def("knn_points_idx", &KNearestNeighborIdxCpu, "K-Nearest Neighbor Index (CPU)",
          py::arg("p1"), py::arg("p2"), py::arg("lengths1"), py::arg("lengths2"), py::arg("norm"), py::arg("K"));
    m.def("knn_points_backward", &KNearestNeighborBackwardCpu, "K-Nearest Neighbor Backward (CPU)",
          py::arg("p1"), py::arg("p2"), py::arg("lengths1"), py::arg("lengths2"), py::arg("idxs"), py::arg("norm"), py::arg("grad_dists"));
}
